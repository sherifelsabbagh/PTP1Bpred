...
st.info('This App can be used to predict whether a molecule would be active or inactive against PTP1B target protein.')
...
st.write("You can find information about PTP1B protein in the third page.")
